...
— Fundo de papel bege #F1F1EC ou kraft #E9E5DA com grão visível — nunca branco puro nem cinza frio
...
— Acentos desenhados à mão em terracota #B32616: círculo à volta de uma palavra, seta curva, sublinhado
...
— Sensação: alguém abriu a pasta de referências na mesa e começou a explicar`,
    overlayStyle: 'capa', overlayTokens: { bg: '#F1F1EC', text: '#B32616', realce: '#E8B8B2', hand: '#242321' },
...
— Sensação: um cartão impresso colado na página`,
    overlayStyle: 'cartao', overlayTokens: { bg: '#B32616', text: '#FAF9F4' },
    slideCount: 1, canvaUrl: null, profile: 'pessoal',
  },
  {
...
— Sensação: baixar o tom de voz`,
    overlayStyle: 'cartao', overlayTokens: { bg: '#811F16', text: '#FAF9F4' },
    slideCount: 1, canvaUrl: null, profile: 'pessoal',
  },
  {
...
— Sensação: página de revista com o mesmo grid tela após tela`,
    overlayStyle: 'lista', overlayTokens: { bg: '#F1F1EC', accent: '#B32616', text: '#242321', kicker: 'ana moutinho' },
    slideCount: 1, canvaUrl: null, profile: 'pessoal',
  },
  {
...
— Idêntico à Lista Editorial, em papel kraft #E9E5DA para alternar telas e dar ritmo ao carrossel
— Mantém o mesmo grid: rótulo no topo, título, corpo, recorte abaixo`,
    overlayStyle: 'lista', overlayTokens: { bg: '#E9E5DA', accent: '#811F16', text: '#242321', kicker: 'ana moutinho' },
    slideCount: 1, canvaUrl: null, profile: 'pessoal',
  },
  {
...
— Usar quando o carrossel anterior já foi vermelho`,
    overlayStyle: 'lista', overlayTokens: { bg: '#F1F1EC', accent: '#7C8A6E', text: '#242321', kicker: 'ana moutinho' },
    slideCount: 1, canvaUrl: null, profile: 'pessoal',
  },
  {
...
— Sensação: alguém colou um print e escreveu ao lado o que achou`,
    overlayStyle: 'nota', overlayTokens: { bg: '#F1F1EC', accent: '#B32616', text: '#242321', label: 'o ponto' },
    slideCount: 1, canvaUrl: null, profile: 'pessoal',
  },
  {
...
— Fundo em gradiente vinho profundo #811F16 com variação de luz no canto superior — profundidade, nunca cor chapada
...
— Sensação: statement calmo e definitivo`,
    overlayStyle: 'estatico', overlayTokens: { bg: '#811F16', bgTopo: '#B32616', text: '#FAF9F4', destaque: '#E8B8B2' },
    slideCount: 1, canvaUrl: null, profile: 'pessoal',
  },
  {
...
— Sensação: intimista, luz de fim de tarde, pausa`,
    overlayStyle: 'estatico', overlayTokens: { veil: 'rgba(38,30,20,.52)', text: '#FAF9F4', destaque: '#C9D2BC' },
    slideCount: 1, canvaUrl: null, profile: 'pessoal',
  },
  {
...
— Sensação: ponto final com convite`,
    overlayStyle: 'fechamento', overlayTokens: { bg: '#242321', text: '#FAF9F4', accent: '#E8B8B2' },
    slideCount: 1, canvaUrl: null, profile: 'pessoal',
  },
];
